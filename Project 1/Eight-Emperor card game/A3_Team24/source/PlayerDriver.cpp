...
public:
    void run()
    {
        ...
        vector<Card *> cards;
        Bidding *bid = new Bidding("Ben", 11);
        Player *ben = new Player("Ben", 7, 18, territoryList, cards, bid,"Green");
        Territory *territory1 = new Territory("territory1", "continent1", 0, 0, false, "", false, 0);
        Territory *territory2 = new Territory("territory2", "continent2", 0, 0, false, "", false, 0);
        Territory *territory3 = new Territory("territory3", "contiennt3", 0, 0, false, "", false, 0);
